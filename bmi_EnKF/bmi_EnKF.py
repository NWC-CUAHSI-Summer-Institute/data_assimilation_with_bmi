...
class BMIEnKF(Bmi):
    ...
    def __init__(self, n, m, R, Q, N, x0, P, n_steps):
        self.n = n
        self.m = m
        self.R = R
        self.Q = Q
        ...
        self.state_estimates = np.zeros((n, n_steps))
        self.covariance_matrices = np.zeros((n, n, n_steps))
        self.current_step = 0
    ...
    def update(self, yi, F_results, H_results):
        ...
        self.state_estimates[:, self.current_step] = self.enkf.get_state_estimate()
        self.covariance_matrices[:, :, self.current_step] = self.enkf.get_covariance()
        self.current_step += 1
